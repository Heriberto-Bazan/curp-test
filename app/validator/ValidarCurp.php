...
class ValidarCurp
{
    ...
    public function __construct($nombres, $apellido_paterno, $apellido_materno, $fecha_nacimiento, $genero, $num_entidad)
    {
        ...
        $this->entidades  =  $this->entidades_mexico();
        $this->unwanted_array = $this->lista_letras();
    ...
    public function lista_letras(){
        $lista_letras =  array('Š'=>'S', 'š'=>'s', 'Ž'=>'Z', 'ž'=>'z', 'À'=>'A', 'Á'=>'A', 'Â'=>'A', 'Ã'=>'A', 'Ä'=>'A', 'Å'=>'A', 'Æ'=>'A', 'Ç'=>'C', 'È'=>'E', 'É'=>'E',
    ...
    public function entidades_mexico(){
     ...
     */
    private function digito_verificador($curp)
    {
     ...
     * es válida.
     */
    private function es_nombre_invalido($name)
    {
     ...
     */
    private function cambiar_letras_indeseadas($palabra)
    {
     ...
     */
    private function cambiar_palabra_altisonante($curp)
    {
     ...
     */
    private function generar($nombres, 
        $apellido_paterno, 
        $apellido_materno,
        $fecha_nacimiento, 
        $genero, 
     ...
     */
    public function comparar($curp, $omitir_codigos = [])
    {
        $codigos = [
